...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'home.hero.btn.events': 'Próximos eventos',
    ...
    // events home
    'home.events.subhead': 'Próximos Eventos',
    'home.events.teaser': 'Conoce el próximo evento de la iglesia y revive en fotos los que ya compartimos juntos.',
